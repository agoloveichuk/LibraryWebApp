...
namespace LibraryWebApp.Application.Services
{
    public sealed class AuthenticationService : IAuthenticationService
    {
        ...
        {
            var key = Encoding.UTF8.GetBytes("sBJl3g32eA8ioLhle1R9hD3sJnG4VN+FQJQfFF/eIzU="); // CHANGE, NOT SECURE
        ...
        private ClaimsPrincipal GetPrincipalFromExpiredToken(string token)
        {
            ...
            var tokenValidationParameters = new TokenValidationParameters
            {
                ...
                IssuerSigningKey = new SymmetricSecurityKey( Encoding.UTF8.GetBytes("sBJl3g32eA8ioLhle1R9hD3sJnG4VN+FQJQfFF/eIzU=")), // CHANGE, NOT SECURE
